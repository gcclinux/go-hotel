...
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		resp := jsonResponse{
			OK:      false,
			Message: "Error connectin to Database",
		}
...
// ReservationSummary returns the information provided by PostReservation
...
// ChooseRoom display list available rooms
...
// BookRoom takes URL parameters, builds a session varible and takes user to make a res screen
