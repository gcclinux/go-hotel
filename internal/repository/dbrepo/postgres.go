...
// SearchAvailabilityByDateByRoomID returns true if availabiloty exists for roomID and false if availability does not exists
...
// SearchAvailabilityForAllRooms  retur a slice of available rooms if any for given date range
...
// GetRoomByID gets a room name by ID
func (m *postgresDBRepo) GetRoomByID(id int) (models.Room, error) {
	...
	query := `
		SELECT id, room_name from public.rooms WHERE id = $1
	`
